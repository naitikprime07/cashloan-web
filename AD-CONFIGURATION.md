...
| --- | --- | --- |
| Display / dropdownNext | index, loan-amount, employment-type, loan-type, proceed | /23338698373/cashloanplatform_native_in_content_01/_02/_03/_04/_05 (one per page; each size list ends with "fluid") |
...
- Since release 20260922-9 the five dropdownNext units also list "fluid" after the fixed sizes: a native in-content fluid creative renders at the full container (Next button) width on any device, while the fixed sizes remain eligible as fallback, so fill cannot regress. The container reserves 250px via min-height and may grow for a taller fluid creative. See FIVE-PAGE-ADS.md.
